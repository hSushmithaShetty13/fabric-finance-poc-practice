...
VALUES
    ...
    ('Invoices',      'Files/landing/invoices/',        '*.csv', 'Invoices',      'Silver_Invoices',      'Full',        NULL,          1.0, 1,
    ...
    ('Payments',      'Files/landing/payments/',        '*.csv', 'Payments',      'Silver_Payments',      'Full',        NULL,          1.0, 1,
